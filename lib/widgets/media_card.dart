...
class _MediaCardState extends State<MediaCard> with SingleTickerProviderStateMixin {
  ...
  // Use nullable types and initialize them in initState without 'late'
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: _animationController == null 
            ? _buildCardWithoutAnimation() // Fallback if animation fails to initialize
            : AnimatedBuilder(
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: LinearProgressIndicator(
                  value: widget.media.watch.current / widget.media.watch.total,
